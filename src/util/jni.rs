...
#[no_mangle]
#[allow(unsafe_code)]
pub unsafe extern "system" fn Java_cp_player_provider_JniProvider_startNativeServer(
    mut env: JNIEnv,
    _class: JClass,
    host: JString,
    port: i32,
...
#[no_mangle]
#[allow(unsafe_code)]
pub unsafe extern "system" fn Java_cp_player_provider_JniProvider_nativeCallApi(
    mut env: JNIEnv,
    _class: JClass,
    method: JString,
    params_json: JString,
...
#[no_mangle]
#[allow(unsafe_code)]
pub unsafe extern "system" fn Java_cp_player_provider_JniProvider_analyzeAudioFile(
    mut env: JNIEnv,
    _class: JClass,
    path: JString,
) -> jstring {
